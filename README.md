<h1 align="center"> Luka Pintor Reatti</h1>
...
<p align="center">
   <img src="https://readme-typing-svg.herokuapp.com/?color=017501&size=26&center=true&vCenter=true&width=600&lines=Turning+logic+into+solutions;FullStack+Developer+in+progress;Learning+something+new+every+day" />
</p>
...
class Luka:
    def __init__(self):
        self.nickname = "Luka"
        self.level = "Desenvolvedor em formação"
        self.campus = "Sistemas de Informação - FHO"
        self.skills = ["C++", "Python", "Machine Learning"]
        self.current_quest = "Evolução prática e construção de projetos"
